...
namespace B13_Ex02_1
{
    ...
    public class Board
    {
        ...
        private List<PlayerBoardPiece> m_CirclePieces;

        /* An array of all the X pieces on the board. */
        private List<PlayerBoardPiece> m_XPieces;
        ...
        public Board(int i_BoardSize)
        {
            ...
            m_CirclePieces = new List<PlayerBoardPiece>();
            m_XPieces = new List<PlayerBoardPiece>();
         ...
         */
        public List<PlayerBoardPiece> CirclePieces
        {
            get
            {
         ...
         * Gets or sets an array of the circle pieces on the board.
         */
        public List<PlayerBoardPiece> XPieces
        {
            get
            {
                return m_XPieces;
        ...
        public void InitializeBoard()
        {
            ...
            for (int row = 0; row < numberOfRowsWithPieces; row++)
            {
                for (int column = 0; column < m_BoardSize; column++)
                {
                    ...
                    else
                    {
                        ...
                        m_CirclePieces.Add(new PlayerBoardPiece(row, column));
                    }
                }
            ...
            startingPieceLocation = numberOfRowsWithPieces % 2 == 0 ? 0 : 1;
            ...
            for (int row = numberOfRowsWithPieces + 2; row < m_BoardSize; row++)
            {
                for (int column = 0; column < m_BoardSize; column++)
                {
                    ...
                    if (startingPieceLocation % 2 == 0)
                    {
                        ...
                        m_XPieces.Add(new PlayerBoardPiece(row, column));
                    }
                    else
                    {
                        m_GameBoard[row, column] = eBoardPieces.Empty;
